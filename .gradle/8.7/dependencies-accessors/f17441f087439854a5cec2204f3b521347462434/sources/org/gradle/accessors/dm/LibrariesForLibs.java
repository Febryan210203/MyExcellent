...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final PopupLibraryAccessors laccForPopupLibraryAccessors = new PopupLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>popup</b>
     */
    public PopupLibraryAccessors getPopup() {
        return laccForPopupLibraryAccessors;
    }
    ...
    public static class AndroidxNavigationFragmentKtxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v277</b> with <b>androidx.navigation:navigation-fragment-ktx</b> coordinates and
    ...
    public static class AndroidxRuntimeLibraryAccessors extends SubDependencyFactory {
        private final AndroidxRuntimeSavedLibraryAccessors laccForAndroidxRuntimeSavedLibraryAccessors = new AndroidxRuntimeSavedLibraryAccessors(owner);

        public AndroidxRuntimeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.runtime.saved</b>
         */
        public AndroidxRuntimeSavedLibraryAccessors getSaved() {
            return laccForAndroidxRuntimeSavedLibraryAccessors;
        }

    }

    public static class AndroidxRuntimeSavedLibraryAccessors extends SubDependencyFactory {
        private final AndroidxRuntimeSavedInstanceLibraryAccessors laccForAndroidxRuntimeSavedInstanceLibraryAccessors = new AndroidxRuntimeSavedInstanceLibraryAccessors(owner);

        public AndroidxRuntimeSavedLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.runtime.saved.instance</b>
         */
        public AndroidxRuntimeSavedInstanceLibraryAccessors getInstance() {
            return laccForAndroidxRuntimeSavedInstanceLibraryAccessors;
        }

    }

    public static class AndroidxRuntimeSavedInstanceLibraryAccessors extends SubDependencyFactory {

        public AndroidxRuntimeSavedInstanceLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>state</b> with <b>androidx.compose.runtime:runtime-saved-instance-state</b> coordinates and
         * with version reference <b>runtimeSavedInstanceState</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getState() {
            return create("androidx.runtime.saved.instance.state");
        }
    ...
    public static class PopupLibraryAccessors extends SubDependencyFactory {

        public PopupLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>dialog</b> with <b>com.saadahmedev.popup-dialog:popup-dialog</b> coordinates and
         * with version reference <b>popupDialog</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getDialog() {
            return create("popup.dialog");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebaseBom</b> with value <b>33.16.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>navigationFragmentKtxVersion</b> with value <b>2.7.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>popupDialog</b> with value <b>2.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPopupDialog() { return getVersion("popupDialog"); }

        /**
         * Version alias <b>roomRuntime</b> with value <b>2.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>runtimeSavedInstanceState</b> with value <b>1.0.0-alpha11</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRuntimeSavedInstanceState() { return getVersion("runtimeSavedInstanceState"); }
